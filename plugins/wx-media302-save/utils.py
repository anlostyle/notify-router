...
class wxMedia302Config:
    """wx-media302配置管理"""
    PLUGIN_ID = "wx-media302-save"
    ...
    def _fetch_config(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"获取wx-media302配置失败: {e}")
            return None
        ...
        if (self._config_cache is None or 
            ...
            if config_data:
                try:
                    ...
                    logger.error(f"解析wx-media302配置失败: {e}")
                    return None
            else:
                self._config_cache = None
                self._last_fetch_time = current_time
    ...
    def validate_config(self) -> Dict[str, bool]:
        ...
        validation_result = {
            ...
            'media302_url': bool(self.media302_url),
            'media302_token': bool(self.media302_token),
        }
